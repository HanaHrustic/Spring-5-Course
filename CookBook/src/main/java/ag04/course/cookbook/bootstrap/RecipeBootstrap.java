...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, CategoryService categoryService, RecipeService recipeService, UnitOfMeasureService unitOfMeasureService) {
    ...
    private List<Recipe> getRecipes(){
        ...
        UnitOfMeasure eachUom = unitOfMeasureService.getUnitOfMeasure("Each");
        UnitOfMeasure tableSpoonUom = unitOfMeasureService.getUnitOfMeasure("TableSpoon");
        UnitOfMeasure teaSpoonUom = unitOfMeasureService.getUnitOfMeasure("TeaSpoon");
        UnitOfMeasure dashUom = unitOfMeasureService.getUnitOfMeasure("Dash");
        UnitOfMeasure pintUom = unitOfMeasureService.getUnitOfMeasure("Pint");
        UnitOfMeasure cupsUom = unitOfMeasureService.getUnitOfMeasure("Cup");

        Category americanCategory = categoryService.getCategory("American");
        Category mexicanCategory = categoryService.getCategory("Mexican");
